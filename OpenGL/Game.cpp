...
void Game::initTextures()
{
	...
	this->textures.push_back(new Texture("Images/pusheen_specular.png", GL_TEXTURE_2D, 1));

	//TEXTURE 1
	this->textures.push_back(new Texture("Images/container.png", GL_TEXTURE_2D, 2));
	this->textures.push_back(new Texture("Images/container_specular.png", GL_TEXTURE_2D, 3));
}
